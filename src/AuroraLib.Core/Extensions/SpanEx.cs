...
namespace AuroraLib.Core.Extensions
{
    public static class SpanEx
    {
        ...
        public static bool SequenceContains<T>(this ReadOnlySpan<T> values, ReadOnlySpan<T> sequence)
        ...
        [DebuggerStepThrough]
        public static int SequenceSearch<T>(this ReadOnlySpan<T> values, ReadOnlySpan<T> sequence)
        {
